      ...
      <div className="flex items-center justify-center h-screen bg-background text-foreground">
        <div className="flex flex-col items-center space-y-4">
          <div className="relative">
            ...
            <Sparkles className="h-6 w-6 text-cyan-400 absolute -top-2 -right2 animate-pulse" />
          </div>  
          <span className="text-muted-foreground fomt-medium">Loading meal data...</span>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen w-full bg-background p-6 overflow-auto">
      ...
      <div className="w-full space-y-8">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-lg mt-2 text-muted-foreground">Track your daily nutrition goals and maintain a healthy lifestyle</CardDescription>
              </div>
              <div className="flex items-center gap-6">
                ...
                <div className="text-center p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                  <div className="text-2xl font-bold text-primary">{nutritionScore}%</div>
                  <div className="text-sm text-muted-foreground font-medium">Nutrition Score</div>
                </div>
                <div className="text-center p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
          ...
          <CardContent>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-3 p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                ...
                <Progress value={nutritionScore} className="h-3 rounded-full" />
              </div>
              ...
              <div className="space-y-3 p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                ...
                <Progress value={(meals.length / 4) * 100} className="h-3 rounded-full" />
              </div>
              <div className="space-y-3 p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                <div className="flex justify-between text-sm">
                  <span className="font-medium flex items-center gap-2">
                ...
                <Progress value={weeklyAverage} className="h-3 rounded-full" />
              </div>
              <div className="space-y-3 p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                <div className="flex justify-between text-sm">
                  <span className="font-medium flex items-center gap-2">
                    <Zap className="h-4 w-4 text-ornage-500" />
                    Consistency
                  </span>
                ...
                <Progress value={consistencyScore} className="h-3 rounded-full" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        {/* Goal Settings Panel */}
        {showGoalSettings && (
          <Card className="border-2 border-border bg-card shadow-2xl backdrop-blur-sm">
            <CardHeader>
            ...
            <CardContent>
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button onClick={handleSaveGoals} className="bg-muted hover:bg-cyan-700"> Save Goals</Button>
              </div>
            </CardContent>
          </Card>
        )}
        ...
        {/* Motivational Banner */}
        <Card className="bg-card border-border shadow-2xl backdrop-blur-sm hover:shadow-xl transition-all duration-300">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card className="lg:col-span-2 shadow-lg backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardContent>
              ...
              <Button
                ...
                className="w-full mt-6 bg-gradient-to-br from-pink-500 to-red-500 hover:bg-cyan-50 shadow-lg hover:shadow-xl transition-all duration-300"
          ...
          <Card className="bg-card border-border shadow-lg backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="flex items-center font-bold gap-4 text-xl">
        ...
        {/* Enhanced Meals List */}
        <Card className="bg-card border border-border shadow-md backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-xl">
