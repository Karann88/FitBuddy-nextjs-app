...
export function MoodTracker() {
  ...
  useEffect(() => {
    ...
    const fetchMoodData = async () => {
      ...
      if (todayEntry) {
        setMoodValue(todayEntry.mood_value - 1) // Adjust for 0-based index
        ...
        (payload) => {
          ...
          if (payload.eventType === "INSERT" || payload.eventType === "UPDATE") {
            if (newEntry && format(new Date(newEntry.date), "yyyy-MM-dd") === today) {
              setMoodValue(newEntry.mood_value - 1)
            ...
            setMoodData((prev) => {
              const updated = prev.map((item) =>
                format(new Date(item.date), "yyyy-MM-dd") === format(new Date(newEntry?.date || ""), "yyyy-MM-dd")
                  ? {
                    ...item,
                    mood: newEntry ? newEntry.mood_value - 1 : 2,
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-background text-foreground">
        <div className="flex flex-col items-center space-y-4">
          ...
          <span className="text-muted-foreground font-medium">Loading your mood data...</span>
        </div>
      </div>
    )
  }
      ...
      <div className="w-full space-y-8">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-lg mt-2 text-muted-foreground">Track your emotional journey and mental well-being with mindful awareness</CardDescription>
              </div>
              <div className="flex items-center gap-6">
                ...
                <div className="text-center p-4 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md">
                  <div className="text-3xl font-bold text-primary">{moodStats.totalEntries}</div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <Card className="bg-card border-border shadow-2xl backdrop-blur-sm">
            ...
            <CardContent className="space-y-8">
              ...
              <Button
                ...
                className="w-full h-14 bg-gradient-to-br from-pink-500 to-purple-500 hover:text-muted-foreground rounded-xl shadow-lg text-lg font-semibold"
              >
          ...
          <Card className="bg-card border-border shadow-2xl backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl">
                <div className="p-2 rounded-full bg-gradient-to-br from-pink-500 to-green-500 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Card className="bg-card backdrop-blur-sm border-border shadow-md">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-primary">{moodStats.average}/4</div>
                    <p className="text-xs fotnt-semibold text-muted-foreground">
                ...
                <Card className="bg-card backdrop-blur-sm border-border shadow-md">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-muted-foreground">{moodStats.mostCommon}</div>
                    <p className="text-xs font-semibold text-muted-foreground">Your typical mood</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-card backdrop-blur-sm border-border shadow-md">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-primary">{moodStats.streak}</div>
                    <p className="text-xs font-semibold text-muted-foreground">Days tracked</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-card backdrop-blur-sm border-border shadow-md">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs font-semibold text-muted-foreground">This {historyPeriod}</p>
                  </CardContent>
                </Card>
              </div>
            </CardContent>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <Card className="bg-card shadow-2xl backdrop-blur-sm">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="flex items-center gap-3 text-2xl">
