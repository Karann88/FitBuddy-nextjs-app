            ...
            <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
                <div className="flex flex-col items-center space-y-4">
                    <div className="relative">
                        ...
                        <Sparkles className="h-6 w-6 text-indigo-400 absolute -top-2 -right-2 animate-pulse" />
                    </div>
                    <span className="text-indigo-700 font-medium">Loading your stretch data...</span>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6 overflow-auto">
            <div className="w-full max-w-none mx-auto space-y-8">
                ...
                <Card className={`bg-gradient-to-r ${sequenceData.gradient} ${sequenceData.borderColor} shadow-2xl backdrop-blur-sm`}>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-lg mt-2">Transform your day with mindful movement and flexibility</CardDescription>
                            </div>
                            <div className="flex items-center gap-6">
                                <div className="text-center p-4 rounded-xl bg-white/70 backdrop-blur-sm border border-orange-100 shadow-md">
                                    <div className={`text-3xl font-bold ${sequenceData.accentColor}`}>{streak}</div>
                                    <div className="text-sm text-muted-foreground font-medium">Day Streak</div>
                                </div>
                                <div className="text-center p-4 rounded-xl bg-white/70 backdrop-blur-sm border border-orange-100 shadow-md">
                                    <div className={`text-3xl font-bold ${sequenceData.accentColor}`}>{totalSessions}</div>
                    ...
                    <CardContent>
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="space-y-3 p-4 rounded-xl bg-white/70 backdrop-blur-sm border border-yellow-100 shadow-md">
                                <div className="flex justify-between text-sm">
                                    <span className="font-medium flex items-center gap-2">
                    ...
                    <CardContent>
                        <Tabs value={activeSequence} onValueChange={handleSequenceChange}>
                            <TabsList className="grid w-full grid-cols-3 bg-slate-100 p-1 rounded-xl">
                                <TabsTrigger 
                                    value="morning" 
                                    className="data-[state=active]:bg-orange-100 data-[state=active]:text-orange-800 rounded-lg"
                                >
                                ...
                                <TabsTrigger 
                                    value="evening" 
                                    className="data-[state=active]:bg-indigo-100 data-[state=active]:text-indigo-800 rounded-lg"
                                >
                                    <span className="mr-2">🌙</span>
                                    Evening Wind-Down
                                </TabsTrigger>
                                <TabsTrigger 
                                    value="desk" 
                                    className="data-[state=active]:bg-emerald-100 data-[state=active]:text-emerald-800 rounded-lg"
                                >
                                    <span className="mr-2">💻</span>
                                    Desk Break
                                </TabsTrigger>
                        ...
                        <div className="mt-6 p-6 rounded-xl bg-gradient-to-r from-slate-100 to-gray-100 border border-slate-200">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-xl font-semibold text-slate-800">{sequenceData.title}</h3>
                                    <p className="text-slate-600 mt-1">{sequenceData.description}</p>
                                </div>
                                <div className="text-right">
                                    <div className="text-2xl font-bold text-slate-700">{Math.floor(sequenceData.totalTime / 60)}:{(sequenceData.totalTime % 60).toString().padStart(2, '0')}</div>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <Card className="lg:col-span-2 bg-gradient-to-br from-white to-slate-50 border-slate-200 shadow-2xl">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <CardContent className="flex flex-col items-center justify-center space-y-8">
                            ...
                            <div className="relative w-full aspect-square max-w-[400px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                                {currentStretch && (
                        ...
                        <CardFooter className="flex justify-between items-center bg-gradient-to-r from-slate-50 to-gray-50 rounded-b-2xl border-t border-slate-200">
                            <Button 
                                variant="outline" 
                                                    ...
                                                    <Draggable key={stretch.id} draggableId={stretch.id} index={index}>
                                                        {(provided, snapshot) => (
                                                            <div
                                                                ...
                                                                className={`flex items-center gap-3 p-4 rounded-xl border-2 transition-all duration-200 cursor-pointer hover:shadow-md ${
                                ...
                                <div className="space-y-3 max-h-[300px] overflow-y-auto">
                                    {completedStretches.length > 0 ? (
                                        completedStretches.map((stretch) => (
                                            <div key={stretch.id} className="flex items-center justify-between p-3 rounded-lg bg-white/80 backdrop-blur-sm border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                                                <div className="flex-1">
