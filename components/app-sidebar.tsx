...
import { Activity, Home, Calendar, Droplets, Moon, Utensils, Scale, Wind, Dumbbell, StretchVerticalIcon as Stretch, BookHeart, LogOut, LogIn } from "lucide-react"
  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      ...
      <SidebarFooter className="flex flex-col gap-2 p-4">
        {/* Show welcome message when user is authenticated and sidebar is open */}
        {open && user && (
